...
**DEFINITION 2.3** Optimum of a Function：如果存在一个正数$$ \epsilon $$，使得对于范围$$ D $$内的所有点都有$$ | t-t^* | \lt \epsilon $$，则称函数$$ f(t) $$在点$$ t^* $$处存在极值，$$ f(t) $$的增量符号相同。
...
**DEFINITION 2.3** <font color="#33cc00">Optimum of a Function</font>：如果存在一个正的$$ \epsilon $$，使得对于范围$$ \Omega $$内的所有函数$$ x $$都有$$ |x-x^{\*}| \lt \epsilon $$，则称泛函$$ J $$在$$ x^{\*} $$处取到relative optimum，$$ J $$的增量与之同符号。
