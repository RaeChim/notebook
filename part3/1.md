...
<figure>
    <img src="../../notebook\part3\images\fig1_4.JPG" width=400px>
...
&emsp;&emsp;<font color="#3399ff">最优控制问题是基于性能指标的形式进行分类的</font>。如果PI包含$$ S(\mathbf{x}(t),\mathbf{u}(t),t) $$，就是Mayer问题，如果PI只包含积分项，就是Lagrange问题，如果二者都有，就是Bolza问题。
