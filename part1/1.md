...
&emsp;&emsp;针对Bezier曲线，给定空间$$ n+1 $$个点的位置矢量$$ P_i(i=0,1,2,\ldots,n) $$，则Bezier曲线段的参数方程表示如下：
...
其中，$$ B_{0,3}(t)&emsp;B_{1,3}(t)&emsp; B_{2,3}(t)&emsp; B_{3,3}(t) $$为三次Bezier曲线的基函数，均为三次曲线，任何三次Bezier曲线都是这四条曲线的线性组合。

<font color="#3399ff">Bezier曲线不能对曲线形状进行局部控制</font>，如果改变任一控制点位置，整个曲线都会受到影响。
