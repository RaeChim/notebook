...
```note
Possible Condition 3：如果所有的属性的IG值都是0，stop  
（A good idea?）
```
...
（4）每一步都用到了子集中所有数据  
基于统计的搜索选择  
<font color="#3399ff">对噪声数据具有鲁棒性</font>
...
<center>
    <figure>
        <img src="./images/1-3.JPG" width=250px>
    </figure>
</center>
...
2. <font color="#3399ff">在单独的验证数据集上</font>衡量性能
