...
<figure><img src="./images/5-9.JPG" width=500px></figure>
...
<figure><img src="./images/5-11.JPG" width=500px></figure>
...
$$  \nabla_{\theta} \mathbb{E}_{\tau \sim \pi_{\theta}}[R] 
=   \mathbb{E}_{\tau} \left[\sum_{t=0}^{T-1} \color{green}{(G_{t}-b(s_t))} \cdot \nabla_{\theta} \log \pi_{\theta}(a_{t} \mid s_{t})\right]
$$
...
$$  \nabla_{\theta} J(\theta) 
=   \mathbb{E}_{\tau} \left[\sum_{t=0}^{T-1} \color{green}{(G_{t}-b_{\mathbf{w}}(s_t))} \cdot \nabla_{\theta} \log \pi_{\theta}(a_{t} \mid s_{t})\right]
$$
...
<figure><img src="./images/5-12.JPG" width=450px></figure>
