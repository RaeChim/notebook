...
**FAQ**：  
多少层？每层多少个神经元？  
— <b><font color="#3399ff">trial and error + intuition </font></b>  
结构可以自动决定吗？  
...
&emsp;&emsp;这就是机器在深度学习中所做的“学习”，哪怕alphago也是这样学习的。

<figure><img src="./images/1/29.JPG" width=550px></figure>

### Backpropagation

&emsp;&emsp;反向传播：在神经网络中计算$$\frac{\partial L}{\partial \mathbf{w}}$$的高效方式。

<figure><img src="./images/1/30.JPG" width=600px></figure>

<figure><img src="./images/1/31.JPG" width=550px></figure>

<figure><img src="./images/1/32.JPG" width=700px></figure>
