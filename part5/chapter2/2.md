...
<center>
    <figure>
        <img src="./images/2-6.JPG" width=360px>
    </figure>
</center>
...
&emsp;&emsp;寻找最优策略的一种方法是枚举，确定的策略总数为$$|A|^{|S|}$$。其它方法比如policy iteration和value iteration会效率高很多。
...
<center>
    <figure>
        <img src="./images/2-10.JPG" width=240px>
    </figure>
</center>
...
&emsp;&emsp;Value iteration是**把Bellman optimality equation作为规则**来迭代的。如果已知子问题的最优解$$v^*(s')$$，那么按以下贝尔曼最优方程规则迭代，就可以得到最优解$$v^*(s)$$
