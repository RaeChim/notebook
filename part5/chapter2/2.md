...
&emsp;&emsp;以某一个参数$$\pmb{\theta}$$更新的过程为例。原来$$\pmb{\theta}$$的更新为 $$\pmb{\theta}_i^{t+1} \leftarrow \pmb{\theta}_i^t - \eta g_i^t$$，$$\boldsymbol{g}_i^t=\left.\frac{\partial L}{\partial \pmb{\theta}_i}\right|_{\pmb{\theta}=\pmb{\theta}^{t}}$$。现在，将$$\eta$$这项改为$$\frac{\eta}{\sigma_i^t}$$，这是一个与参数相关的学习率。

<figure><img src="./images/2/28.JPG" width=350px></figure>
...
<figure><img src="./images/2/32.JPG" width=500px></figure>
...
<figure><img src="./images/2/35.JPG" width=600px></figure>
