...
&emsp;&emsp;Q-learning中行为策略和目标策略都是允许改进的。<font color="#3399ff">目标策略$$\pi$$对$$Q(s, a)$$贪心</font>

$$\pi(S_{t+1}) = \text{arg}\max_{a'} Q(S_{t+1}, a')$$

<font color="#3399ff">行为策略</font>$$\mu$$可以是完全随机的，但是我们让它随着<font color="#3399ff">对$$Q(s, a)$$的ϵ-贪心而改进</font>。
...
<figure>
    <img src="./images/3-15.JPG" width=600px>
</figure>
...
<figure>
    <img src="./images/3-17.JPG" width=420px>
</figure>
