...
&emsp;&emsp;<b><font color="#3399ff">ACKTR用Kronecker因子近似曲率（K-FAC）简化了Fisher信息矩阵（FIM）的求逆过程，加速了优化。</font></b>
...
&emsp;&emsp;<b><font color="#3399ff">PPO：引入自适应的KL惩罚，所以能更好地保证在置信区域内进行优化。</font></b>性能与TRPO相当，但是因为用一阶优化（SGD）所以求解速度快很多。
