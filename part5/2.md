...
&emsp;&emsp;<font color="#1a8d1a">Feasible domain </font>

$$P = \{ 
    \mathbf{x} \in \mathbf{R}^n | \mathbf{Ax} = \mathbf{b} ,\ \mathbf{Ax} = \mathbf{b} 
\}$$

&emsp;&emsp;<font color="#1a8d1a">Feasible solution</font>

$$  \mathbf{x} \text{ is a } feasible \ solution \text{ if } \mathbf{x} \in P
$$

&emsp;&emsp;<font color="#1a8d1a">Consistency</font>

$$ \text{when } P \neq \emptyset ,\ \text{LP is } consistent $$

&emsp;&emsp;<font color="#1a8d1a">Bounded feasible domain</font>
...
&emsp;&emsp;<font color="#1a8d1a">Bounded LP</font>
...
&emsp;&emsp;一个**polyhedral set**或**polyhedron**是由有限个closed half spaces的交形成的。如果它是非空且有界的，则称它为<font color="#1a8d1a">polytope</font>。
...
<!-- 绿 -->
<font color="#008000"></font>#1a8d1a #00B050 #34d058 #28a745
<!-- 橙 -->
