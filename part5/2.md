...
**例** <font color="#3399ff">$$ H $$是convex的，不是affine的。</font>
...
**例** <font color="#3399ff">$$ H_L $$是convex的，不是affine的。</font>
...
**例** <font color="#3399ff">可行域$$P = \{ \mathbf{x} \in \mathbf{R}^n \vert \mathbf{Ax} = \mathbf{b} ,\ \mathbf{x} \ge 0 \}$$的几何意义？</font>
