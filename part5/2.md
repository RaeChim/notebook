...
&emsp;&emsp;$$\mathbf{A}$$为$$m \times n$$的矩阵且$$m \le n$$，如果$$\mathbf{A}$$有$$m $$个线性无关的列，那么则称$$\mathbf{A}$$<font color="#28a745">full rank满秩（full row rank行满秩）</font>。
...
<center>
    <figure>
        <img src="./images/2-7.JPG" width=130px>
    </figure>
</center>
